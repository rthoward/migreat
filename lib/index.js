...
module.exports = {
    ...
    createMigration: function(settings) {
...
`;
    ...
    migrate: async function(settings, targetVersion) {
    ...
    rollback: async function(settings, targetVersion) {
        const _currentVersion = await currentVersion(settings);
    ...
    runMigrations: async function(db, migrations, currentVersion, targetVersion) {
